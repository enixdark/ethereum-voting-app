...
class Project extends BaseModel
{
    ...
    public function getLink()
    {
        ...
        if ($this->type == self::TYPE_FUNDING) {
            ...
            $url = '/' . Helper::Cleanurl(Helper::khongdau($this->name)) . '-p' . $this->id;
        } else if ($this->type == self::TYPE_COLLECT) {
            $url = '/' . Helper::Cleanurl(Helper::khongdau($this->name)) . '-cl' . $this->id;
        } else {
            $url = '/' . Helper::Cleanurl(Helper::khongdau($this->name)) . '-b' . $this->id;
        }
