                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="current_balance" data-balance="{{ object.balance }}">
                                                <b>Balance:</b><br /> {{ number_format(object.balance, 2) }} ETH</div>
                                        </div>
                                    </div>
                                    {#<div class="row mt-10">
                                        <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mydatepicker" placeholder=""
                                        name="vote_start_time" required value="" id="vote_start_time">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mydatepicker" placeholder=""
                                        name="vote_end_time" required value="" id="vote_end_time">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" rows="4" class="form-control" placeholder="" name="caption"
                                        required value="" id="caption"></textarea>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <span
                                        class="label label-{{ item.getStatusClass() }}">{{ item.getStatusText() }}</span>
                                </td>
                            </tr>
                            {% endfor %}
