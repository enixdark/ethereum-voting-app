                    ...
                    <div class="col-sm-4">
                        <div class="information-donate">
                            ...
                            <div class="d-flex">
                                <div class="input-donate donate-input">
                                    <input type="button" class="form-control btn_donate_amount" id="price-donate1"
                                        title="" value="50">

                                </div>
                                <div class="input-donate donate-input">
                                    <input type="button" class="form-control btn_donate_amount" id="price-donate2"
                                        title="" value="100">

                                </div>
                                <div class="input-donate donate-input">
                                    <input type="button" class="form-control btn_donate_amount" id="price-donate3"
                                        title="" value="150">

                                </div>
                                <div class="input-donate donate-input" style="margin-right: 0">
                                    <input type="button" class="form-control btn_donate_amount" id="price-donate4"
                                        title="" value="200">
                            ...
                            <div class="input-donate-a donate-input">
                                <input type="text" class="form-control donate_amount" id="price-donate5" title=""
                                    placeholder="Insert custom value " value="">
                            </div>
                        ...
                        <div class="information-donate">
                            ...
                            <div class="input-donate-a donate-input">
                                ...
                                <a href="https://ropsten.etherscan.io/address/{{ object.funding_receipt }}"
                                    target="_blank">{{ object.funding_receipt }}</a>
                            </div>

                            <div class="input-donate-a donate-input">
                                <label>Target: </label>
                                <p><span class="project_target"
                                        data-target="{{ object.target }}">{{ number_format(object.target, 2) }}</span>
                                    ETH</p>
                            </div>

                            <div class="input-donate-a donate-input">
                                <label>Raised: </label>
                                <p><span class="project_total_raised">{{ number_format(object.raised, 2) }}</span> ETH
                                </p>
                            </div>

                            <div class="input-donate-a donate-input">
                                <label>Balance: </label>
                                <p><span class="project_total_balance">{{ number_format(object.balance, 2) }}</span> ETH
                                </p>
                            </div>
                        </div>
                        ...
                        <a style="margin-top: 10px" href="/project/withdraw?id={{ object.id }}"
                            class="btn bg-blue text-white btn-detail">Withdraw</a>
                        {% endif %}
                        <p style="margin-top: 8px"><a href="/project/history_withdraw?id={{ object.id }}"><i
                                    class="fa fa-history"></i> History withdraw</a></p>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-center mt-10 mb-10">
                            <a class="btn btn-default {{ user_approve is not empty ? 'bg-success' : 'bg-gray' }}"
                                id="btn_accept" data-user-approve="{{ user_approve.id }}">Yes</a>
                        </div>
                    </div>
                    {% endif %}
                ...
                <div class="col-sm-4">
                    ...
                    <div class="row item_relate">
                        <div class="col-xs-4 col-sm-3 p-0">
                            <img alt=""
                                class="nd_donations_postgrid_causes_2_single_cause_img nd_donations_position_absolute"
                                src="{{ item.getAvatar() }}" title="{{ item.name }}">
                        </div>
                        <div class="col-xs-8 col-sm-9">
                            <h4><a>{{ item.name }}</a></h4>
                            <p>TARGET : {{ number_format(item.target, 2) }} ETH RAISED :
                                {{ number_format(item.raised, 2) }} ETH</p>
...
<input type="hidden" class="project_info" data-start="{{ withdraw.vote_start_time * 1000 }}"
    data-end="{{ withdraw.vote_end_time * 1000 }}" data-id="{{ object.id }}" data-target="{{ object.target }}"
    data-raised="{{ object.raised }}" data-balance="{{ object.balance }}">
