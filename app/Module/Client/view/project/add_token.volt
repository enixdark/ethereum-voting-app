                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="token_name" required
                                        value="{{ data_post['token_name'] }}" id="token_name">
                                </div>
                                <div class="form-group">
                                    <label for="symbol">Token Symbol</label>
                                    <input type="text" class="form-control" placeholder="" name="symbol" required
                                        value="{{ data_post['symbol'] }}" id="symbol">
                                </div>
                                <div class="form-group">
                                    <label for="total_supply">Total Supply</label>
                                    <input type="text" class="form-control" placeholder="" name="total_supply" required
                                        value="{{ data_post['total_supply'] }}" id="total_supply">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify" name="avatar"
                                        data-allowed-file-extensions="png jpg jpeg mp3" id="file_upload" />
