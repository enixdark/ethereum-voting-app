<form id="headerSearchBox" class="form-inline my-md-0 search-area" method="get" action="https://acumen.org"
    role="search">
    <div class="inner">
        <div class="container">
            ...
            <a class="search-close-btn" href="javascript:void(0)">
                <svg width="23px" height="21px" viewBox="0 0 23 21" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="Acumen-Website-v2-Final" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                        ...
                        <g id="Navigation-1---Burger-Tray-B" transform="translate(-901.000000, -40.000000)"
                            stroke="#FFFFFF">
...
<header>
    <div class="container">
        <div class="d-flex">
            <a class="logo" href="/"><img src="/public/uploads/blockchain.png?v={{ time }}"
                    style="width: 350px !important; height: 66px !important;"></a>
            <div class="collapse navbar-collapse w-100" id="navbarsExample07">
                <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                    <ul id="menu-main-menu" class="nav navbar-nav">
                        ...
                        <li class="menu-item dropdown hidden-sm-up"><a title="Investments" href="/auth/login"
                                class="dropdown-toggle"><i class="fa fa-sign-in"></i> Login </a></li>
                        {% else %}
                        <li class="menu-item dropdown hidden-sm-up">
                            <a title="Investments" href="javascript:" class="dropdown-toggle">{{ user_info.username }}
            ...
            <div class="button-area">
                <a href="javascript:void(0)" class="icon-btn showSearchBar"><img width="20"
                        src="/client_resource/assets/img/icon/icon-search.png"></a>
                ...
                <ul class="nav navbar-nav hidden-sm-down">
                    <li class="menu-item  dropdown">
                        ...
                        {% else %}
                        <a title="{{ user_info.eth_address }}" href="javascript:void(0);" style="white-space: nowrap"
                            class="dropdown-toggle text-center">
                            <span class="user_address"
                                data-address="{{ user_info.eth_address }}">{{ user_info.getAddress() }}</span> <span
                                class="caret"></span>
                        </a>
                        {% endif %}
