...
<head>
    ...
    <meta name="description"
        content="This is a decentralized community fund management platform applying Blockchain technology and Smart contracts in community fundraising and management to improve the transparency, safety and efficiency of community financial activitities." />
    <meta property="og:title" content="Blockchain" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="/client_resource/assets/img/facebook.jpg" />
    ...
    <meta name="twitter:image" content="/client_resource/assets/img/facebook.jpg" />
...
<body>
    ...
    <script>
        (function (d, s, id) {
            ...
            js.id = id;
            js.src =
                'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.1&appId=962998917125858&autoLogAppEvents=1';
