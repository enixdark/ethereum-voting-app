                                ...
                                <div id="projects-tab" class="tab-pane active">
                                    <div class="pd-20">
                                        <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i
                                                class="fa fa-bolt mgr-10 profile-icon"></i> PROJECTS</h3>
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ item.id }}</td>
                                                    <td><img height="80" src="{{ item.getAvatar() }}"
                                                    ...
                                                    <td class="menu-action rounded-btn">
                                                        ...
                                                        <a class="btn menu-icon vd_bg-red" target="_blank"
                                                            data-placement="top" data-toggle="tooltip"
                                                            data-original-title="Withdraw"
                                                            href="/project/withdraw?id={{ item.id }}">
