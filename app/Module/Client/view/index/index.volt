    ...
    <section id="page_animation">
        <div class="container home-difference-connect" data-is="active">
            <div class="home-difference-content -left">
                ...
                <p>
                    Blockchain is a decentralized community fund management platform applying Blockchain technology and
                    Smart contracts in community fundraising and management to improve the transparency, safety and
                    efficiency of community financial
                    activitities.
                </p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 box-item-cate">
                    ...
                    <div class="content-img">
                        ...
                        <span class="fa fa-flag title-text goal">Token Name : <em>{{ item.token_name }}
                                ({{ item.symbol }})</em></span>
                        <span class="fa fa-flag title-text goal">Total Supply : <em>{{ item.total_supply }}
                                {{ item.symbol }}</em></span>
                        <p>{{ item.description }}</p>
                        <a href="{{ item is not empty ? item.getLink() : 'javascript:' }}"
                            class="background-our-causes bg-blue">Read More</a>
                        <a href="{{ item is not empty ? item.getLink() : 'javascript:' }}"
                            class="background-our-causes bg-donate pull-right">Buy</a>
                        ...
                        <div class="item-product">
                            ...
                            <p class="mb-0 clearfix">
                                <span class="pull-left"><i class="fa fa-clock-o"></i> <span
                                        class="time_countdown">{{ date('m/d/Y H:i', item.contribute_end_time) }}</span></span>
                                <span class="pull-right"><b>{{ item.min_value }} ETH</b></span>
                            </p>
                            <p class="n-listing-card__price  strong text-center btn-bids">
                                <a href="{{ item.getLink() }}" class="text-white"><i class="fa fa-gavel"></i> Make
                                    Offer</a>
                            </p>
                        </div>
                    </div>
