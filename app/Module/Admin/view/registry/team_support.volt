            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <h4 class="mt-0 header-title">Danh sách người hỗ trợ</h4>
                        </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 col-md-9 list_slide">
                                            ...
                                            <div class="row slide_item pt-3 border border-info mt-3 mb-3">
                                                <div class="col-sm-11 col-md-11">
                                                    <a href="/{{ config.media.host ~ item.avatar }}"><img
                                                            src="/{{ config.media.host ~ item.avatar }}" alt=""
                                                            width="200px" height="200px"></a>
                                                    <input type="hidden" name="media[]" value="{{ item.avatar }}">
                                                </div>
                                                <div class="col-sm-1 col-md-1">
                                                    <button
                                                        class="btn btn-sm btn-danger waves-effect waves-light btn_delete_slide_item"><i
                                            ...
                                            <div class="row slide_item pt-3 border border-info mt-3 mb-3">
                                                <div class="col-sm-11 col-md-11">
                                                    <input type="file" name="team_support[]" value=""
                                                        data-default-file="" class="dropify" data-height="220"
                                        ...
                                        <div class="col-sm-8 offset-3 pt-3">
                                            <button type="button"
                                                class="btn btn-sm btn-info waves-effect waves-light btn_add_slide"><i
                                                    class="fa fa-plus-square"> Thêm ảnh</i></button>
                                        </div>
...
<script type="text/html" id="slide_item">
    <div class="row slide_item pt-3 border border-info mt-3 mb-3">
        <div class="col-sm-11 col-md-11">
            <input type="file" name="team_support[]" value="" data-default-file="" class="dropify" data-height="220"
                data-allowed-file-extensions="png jpg jpeg gif" />
        </div>
        <div class="col-sm-1 col-md-1">
            <button class="btn btn-sm btn-danger waves-effect waves-light btn_delete_slide_item"><i
                    class="fa fa-trash-o"> Xóa</i></button>
        </div>
