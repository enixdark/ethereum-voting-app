        ...
        <div class="left side-menu">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="{{ url('dashboard') }}" class="logo"><i class="mdi mdi-assistant"></i> Blockchain</a>
                </div>
            </div>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li
                            class="{{ active_menu == item['active_key'] ? 'active' : '' }} {{ item['child']|length >0 ? "has_sub" : '' }}">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                ...
                                <li><a target="{{ citem['target'] }}" href="{{ citem['link'] }}"
                                        class="{{ active_menu == citem['active_key'] ? 'active' : '' }}">{{ citem['name'] }}</a>
                                </li>
                                {% endif %}
                                {% endfor %}
                            </ul>
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user"
                                    ...
                                    aria-expanded="false">
                                    <img src="/admin_resource/custom/images/avatar-blank.jpg" alt="user"
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <a class="dropdown-item" href="{{ url('auth/logout') }}"><i
