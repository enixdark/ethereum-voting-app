...
(function (factory) {
        ...
        _createEvents: function () {
            ...
            element.on(Metro.events.click, ".heading", function () {
                ...
                if (frame.hasClass("active")) {
                    if (active.length === 1 && o.oneFrame) {} else {
    ...
    var DatePicker = {
        ...
        _addScrollEvents: function () {
            ...
            $.each(lists, function () {
                ...
                list.on(Metro.events.scrollStop, {
                    latency: 50
                }, function () {
            ...
            notify.hide(function () {
                ...
                notify.css({
                    ...
                    notify.animate({
                        ...
                        if (options !== undefined && options.keepOpen === true) {} else {
                            setTimeout(function () {
    ...
    var Streamer = {
        ...
        selectEvent: function (event, state) {
            ...
            if (state === true) event.addClass("selected");
    ...
    var Tabs = {
        ...
        _create: function () {
            ...
            expandButton = $("<span>").addClass("expand-button").html("<span></span>");
